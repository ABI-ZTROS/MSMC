...
public class ConfigImpactAnalyzer
{
    ...
    private readonly List<Rule> _rules = new()
    {
        ...
        new()
        {
            ...
            Icon = "🔴",
            Description = "关闭正版验证→任何玩家都能以任意昵称进入服务器，存在被冒名顶替和 grief 风险",
        ...
        new()
        {
            ...
            Icon = "🔵",
            Description = "开启正版验证，仅 Minecraft 正版账号可进入",
        ...
        new()
        {
            ...
            Icon = "🟡",
            Description = "全服玩家互相 PvP 被禁用，玩家间无法直接攻击",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = "启用白名单：请确认你自己在白名单内，否则保存后连管理员也无法进入",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = Eq(after, "hard")
                ? "全服刷怪难度提升到 hard：怪物伤害更高、AI 更激进，低装备玩家易死亡"
                : $"全服难度由 {before} 提升至 {after}，生存体验明显变化",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Info,
            Icon = "🔵",
            Description = $"难度降低（{before} → {after}），怪物生成和伤害减少",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.High,
            Icon = "🔴",
            Description = $"视距由 {before} 加大到 {after}：内存占用和 CPU 会显著上涨，低配置机器可能导致 TPS 骤降",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Info,
            Icon = "🔵",
            Description = $"视距减小（{before} → {after}），有助于释放内存和降低 CPU 占用",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"更大的自动保存批次（{before} → {after}），每次保存写入更多区块，可能造成瞬时卡顿峰值",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"世界刷怪上限提高（{before} → {after}），单位体积内怪物数量上限增加",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"默认游戏模式切换为 creative：新玩家进入即获得创造权限，可能破坏生存经济平衡",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Info,
            Icon = "🔵",
            Description = "地图种子已变更：该改动仅对尚未生成的新区块生效，已生成的世界不会重新生成",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"最大玩家数由 {before} 提升到 {after}，同时在线人数上限增加",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"服务器端口变更（{before} → {after}），玩家需用新端口连接",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Info,
            Icon = "🔵",
            Description = "服务器标语（MOTD）已更新，玩家在多人游戏列表中看到的介绍文字会变化",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Info,
            Icon = "🔵",
            Description = "允许飞行：原版飞行类 Mod/客户端移动不再被自动踢出",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = "命令方块已启用：OP 可放置并执行指令，错误的连锁指令可能造成服内异常",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Info,
            Icon = "🔵",
            Description = "资源包地址已更新，玩家进入服务器时会被提示下载新资源包",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = "强制游戏模式：所有玩家进入时会被强制切换到 server.properties/gamemode 指定的模式",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"出生点保护范围扩大（{before} → {after}），非 OP 在出生点方圆内无法破坏或放置方块",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.Medium,
            Icon = "🟡",
            Description = $"玩家挂机超时已设置为 {after} 分钟，长时间 AFK 玩家会被自动踢出",
        ...
        new()
        {
            ...
            Severity = ImpactSeverity.High,
            Icon = "🔴",
            Description = "极限模式已开启：玩家死亡后无法复活，自动切换到 spectator 视角，且无法通过 /gamemode 解除",
