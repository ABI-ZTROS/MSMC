...
// 依赖组件: System.IO, System.Text.Json, Serilog, io.NET.ZTR_OS.Models
...
/// 核心职责：
/// <list type="bullet">
/// <item>配置加载：从%AppData%/io.NET.ZTR_OS/app-config.json读取并反序列化全局配置</item>
...
{
    /// <summary>
    /// 配置文件所在目录路径（%AppData%/io.NET.ZTR_OS）
    /// </summary>
